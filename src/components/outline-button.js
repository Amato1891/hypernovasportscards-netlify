...
const OutlineButton = (props) => {
  return (
    <div className='logo-container'>
      <button className="styled-button" onClick={() => handleClick(props.href)}>
        {props.button1}
        <svg className='logo-svg' xmlns="http://www.w3.org/2000/svg" width="180" height="72" viewBox="0 0 120 60">
